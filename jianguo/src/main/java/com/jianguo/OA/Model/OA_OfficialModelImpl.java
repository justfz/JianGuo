 ...
 */
public class OA_OfficialModelImpl implements OA_OfficialModel {
    @Override
    public void getOfficial(final OA_OfficialView view) {
        if (OAUtils.content==null){
            ...
            OKHttpUtils.getClient_oa().newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    List<NewsBean> list = OAUtils.readingOfficial();
                    view.setOfficial(list);
                }
            });
        }else {
            List<NewsBean> list = OAUtils.readingOfficial();
