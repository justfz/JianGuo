 ...
 */
public class OAFragment_official extends Fragment implements OA_OfficialView, OA_RecycleViewAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_oa_official, null);
        official_recy = (RecyclerView) view.findViewById(R.id.oa_official_recy);
    ...
    @Override
    public void setOfficial(final List<NewsBean> list) {
